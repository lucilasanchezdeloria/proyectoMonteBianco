...
- Footer adaptativo, coherente en todas las páginas.
- Estilos personalizados sobre Bootstrap y Flex para reforzar la estética de marca.
- Diseño mobile-first, optimizado para distintos tamaños de pantalla.
